using Tyuiu.DolganovAA.Sprint4.Task4.V6.Lib;
namespace Tyuiu.DolganovAA.Sprint4.Task4.V6
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Выполнила: Долганов Александр Анатольевич | СМАРТб-24-1                       *");
            Console.WriteLine("***************************************************************************");
