...
using Tyuiu.DolganovAA.Sprint4.Task2.V25.Lib;
namespace Tyuiu.DolganovAA.Sprint4.Task2.V25
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("*и в диапазоне от 3 до 9 подсчитать произведение четных элементов массива.*");
